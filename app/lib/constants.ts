import { Facebook, Instagram, Linkedin, LinkIcon, Music, Twitter, Youtube } from 'lucide-react';

import type { SocialLink, SocialMedia, Website } from './types';

export const PUBLIC_ROUTES = ['/auth', '/home', '/about', '/races', '/api/stripe/webhook'];
